...
export const programmingLanguages: ITechData[] = [
	{
		image: C,
		title: 'C',
		date: '1972',
		desc: [
			'C is a compiled programming language of general purpose, structured, imperative, procedural, standardized by International Organization for Standardization ( ISO ), created in 1972 by Dennis Ritchie in the company AT&T Bell Labs for the development of operating system Unix ( originally written in Assembly).',
